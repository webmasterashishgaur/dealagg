<div class="row-fluid clearfix website" id="{website}" style="vertical-align: middle;height: 107px;margin-top:10px;position: relative;">
	<div class="span2" style="text-align: center">
		<a style="line-height: 75px" href='{website_search_url}' target='_blank'><img src="{website_url}" alt="{website}" title="{website}"/></a>
		<button class='btn btn-mini remove_website_btn' style="display: none">Remove This!</button>
	...
	<div class='span3 table-bordered last-div' style="border-left: 1px solid #DDD;margin-left:10px;width:260px;height: 100%">
 		<div style="font-size:11px;margin-left:5px;line-height: 15px">
			<b>Coupons:</b><br/> {coupons}
		</div>	
	</div>
	<div class="span3 other_info_parent table-bordered" style="margin-left:10px;border-left: 1px solid #DDD;height: 100%;overflow-y:auto">
 	...
 	<div class='span3 table-bordered last-div' style="border-left: 1px solid #DDD;margin-left:10px;width:260px;height: 100%;display: none">
